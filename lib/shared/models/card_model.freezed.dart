...
abstract class $CardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String cardNumber, String brand});
}
...
class _$CardModelImpl implements _CardModel {
  const _$CardModelImpl(
      {required this.id, required this.cardNumber, required this.brand});
  ...
  @override
  String toString() {
    return 'CardModel(id: $id, cardNumber: $cardNumber, brand: $brand)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, cardNumber, brand);
...
abstract class _CardModel implements CardModel {
  const factory _CardModel(
      ...
      required final String brand}) = _$CardModelImpl;
